  ...
  <div>
      ...
      <section class="address" >
        ...
        <section class="title">
          ...
          <div class="area"  :class="City?'':'active'">{{City?City:'请选择'}}</div>
...
export default {
  ...
  methods: {
    ...
    closeAdd: function() {
      ...
      // this.$store.state.showChose = this.showChose
      this.$store.commit('change')
    },
    ...
    //   console.log(this.Province,this.City,this.District)
      this.$store.state.Province = this.Province + "/" + this.City + "/" + this.District;
      setStore('userProvince', this.$store.state.Province)
    //   this.$store.state.City = this.City;
    //   this.$store.state.District = this.District;
    //   console.log(this.$store.state.Province,this.$store.state.City,this.$store.state.District)
    },
...
.address .title .active{
  color: #7ACCC8;
  border-bottom:0.02rem solid #7ACCC8;
}
.address ul .active{
  color:#7ACCC8;
}
